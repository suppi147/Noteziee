    ...
    <div class="container">
      <div class="row">
       ...
       <div data-aos="fade-left"  class="col-md-7 text-part">
        ...
        <p>Due to the lack of resources so suppi147 only allow 50 notes to be commented per a user. If you touch the limits you might want to get rid some of those notes or maybe everything.
        </p>
