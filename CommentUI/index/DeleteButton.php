...
class DeleteButton{
    ...
    function DeleteButtonPack($deleteID){
      ...
      $this->comfirmModalHeader='<button type="button" class="btn btn-danger" data-toggle="modal" onclick="ToggleOn1('.$deleteID.');ChecklistArray('.$deleteID.');" data-target="#'.$randomModalID.'">
        Delete
        </button>
        <!-- Modal -->
        ...
        $this->DeleteButton='<button type="button" onclick="deleteID('.$deleteID.');" data-dismiss="modal" class="btn btn-danger ">Confirm</button>';
